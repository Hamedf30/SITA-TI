...
use App\Http\Controllers\MhsPklUsulanController;
use App\Http\Controllers\MhsPklLogBookController;
...
Route::group(['middleware' => ['auth', 'checkRole:dosen']], function () {
    ...
    Route::get('/bimbingan/pembimbing1', [BimbinganController::class, 'indexForPembimbing1'])->name('bimbingan.pem1');
    Route::get('/bimbingan/pembimbing2', [BimbinganController::class, 'indexForPembimbing2'])->name('bimbingan.pem2');
    Route::get('/dosen/bimbingan/{mahasiswa}', [BimbinganController::class, 'detail'])->name('bimbingan.detail');
    Route::post('/dosen/bimbingan/{mahasiswa}/feedback', [BimbinganController::class, 'feedback'])->name('bimbingan.feedback');
...
Route::group(['middleware' => ['auth', 'checkRole:mahasiswa']], function () {
    ...
    Route::get('/bimbingan-TA', [BimbinganController::class, 'index'])->name('Bimbingan.index');
    ...
    Route::resource('bimbingan', BimbinganController::class);
    Route::post('bimbingan/check-status', [BimbinganController::class, 'checkBimbinganStatus'])->name('bimbingan.check-status');
    ...
    Route::resource('mhs_pkl_usulan', MhsPklUsulanController::class);
    Route::get('/mhs_pkl_usulan', [MhsPklUsulanController::class, 'index'])->name('mhs_pkl_usulan.index');
    Route::resource('mhs_pkl', MhsPklController::class);
    Route::resource('mhs_pkl_log_book', MhsPklLogBookController::class);
...
Route::group(['middleware' => ['auth', 'checkRole:kaprodi']], function () {
    ...
    Route::get('/mhs_pkl_usulan', [MhsPklUsulanController::class, 'indexForKaprodi'])->name('mhs_pkl_usulan.IndexForKaprodi');


});

Route::group(['middleware' => ['auth', 'checkRole:kajur']], function () {
    Route::get('/kajur/dashboard', [HomeController::class, 'kajur'])->name('kajur.dashboard');
