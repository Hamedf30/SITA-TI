                            ...
                            <table class="table table-striped" id="table-2">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->jekel }}</td>
                                        <td>{{ $data->kelas ?? 'Tidak tersedia' }}</td>
                                        {{-- <td><img src="{{ asset('gambar/mahasiswa/' . $data->gambar) }}" alt="{{ $data->nama }}" class="img-fluid"></td> --}}
                                        <td>
                                            <div class="d-flex">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="kelas" name="kelas" class="form-control @error('kelas') is-invalid @enderror" placeholder="{{ __('Kelas') }}">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
