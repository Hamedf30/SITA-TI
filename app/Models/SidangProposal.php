...
class SidangProposal extends Model
{
    ...
    {
        return $this->hasMany(NilaiPembimbing1::class, 'sidang_proposal_id');
    }

    public function nilaiPembimbing2()
    {
        return $this->hasMany(NilaiPembimbing2::class, 'sidang_proposal_id');
    }

    public function nilaiPenguji()
    {
        return $this->hasMany(NilaiPenguji::class, 'sidang_proposal_id');
    }

    public function nilaiSempro()
    {
        return $this->hasMany(NilaiSempro::class, 'sidang_Proposal_id');
    }
}
