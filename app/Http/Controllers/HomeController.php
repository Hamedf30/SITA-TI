...
class HomeController extends Controller
{
    ...
    public function admin()
    {
        ...
        return view('pages.admin.dashboard', compact('mahasiswa', 'dosen', 'kajur', 'kaprodi', 'ruangan', 'sidangTerjadwal', 'sidangSelesai', 'prodi'));
    }
    ...
    public function kaprodi()
    {
        ...
        $dosen = Dosen::where('prodi_id', $prodi_id)->count();
    ...
    {
        $kajur = Kajur::where('user_id', Auth::id())->first();
        $jurusan_id = $kajur->jurusan_id; // Assuming Kajur has a jurusan_id attribute
        $mahasiswa = Mahasiswa::where('jurusan_id', $jurusan_id)->count();
        $dosen = Dosen::where('jurusan_id', $jurusan_id)->count();
        $kaprodi = Kaprodi::where('jurusan_id', $jurusan_id)->count();
        ...
        return view('pages.kajur.dashboard', compact('mahasiswa', 'dosen', 'kaprodi'));
    }
