...
class NilaiTaController extends Controller
{
    ...
    public function nilai($id)
    {
        ...
        $sidangProposal = SidangProposal::findOrFail($id);

        
        $nilaiPembimbing1 = NilaiPembimbing1::where('sidang_proposal_id', $sidangProposal->id)->with('dosen')->first();
        $nilaiPembimbing2 = NilaiPembimbing2::where('sidang_proposal_id', $sidangProposal->id)->with('dosen')->first();
        $nilaiPenguji1 = NilaiPenguji::where('sidang_proposal_id', $sidangProposal->id)->with('dosen')->first();

        $ratapembimbing = ((optional($nilaiPembimbing1)->total ?? 0) + (optional($nilaiPembimbing2)->total ?? 0)) / 2;
        $ratapenguji = ((optional($nilaiPenguji)->total ?? 0)) / 4;
        $totalnilai = ((optional($nilaiPembimbing1)->total ?? 0) + (optional($nilaiPembimbing2)->total ?? 0) + (optional($nilaiPenguji)->total ?? 0)) / 6;
        ...
        return view('pages.mahasiswa.nilaiSempro.nilai', compact('nilaiPembimbing1', 'nilaiPembimbing2', 'nilaiPenguji', 'ratapembimbing', 'ratapenguji', 'totalnilai', 'statusSidang'));
    }
    ...
    public function indexForAdmin()
    {
        ...
        $jadwals = SidangProposal::with(['dokumen_sidang', 'mahasiswa'])
            ->get();

        return view('pages.admin.nilaiSempro.index', compact('jadwals'));
    }
    ...
    public function nilaiAdmin($id)
    {
        ...
        return view('pages.admin.nilaiSempro.nilai', compact('nilaiPembimbing1', 'nilaiPembimbing2', 'nilaiPenguji', 'ratapembimbing', 'ratapenguji', 'totalnilai', 'statusSidang'));
    }
    ...
    public function indexForKaprodi()
    {
        ...
        return view('pages.kaprodi.nilaiProposal.index', compact('jadwals'));
    }
    ...
    public function nilaiKaprodi($id)
    {
        ...
        return view('pages.kaprodi.nilaiProposal.nilai', compact('nilaiPembimbing1', 'nilaiPembimbing2', 'nilaiPenguji', 'ratapembimbing', 'ratapenguji', 'totalnilai', 'statusSidang'));
    }
    ...
    public function indexForDosen()
    {
        ...
        $jadwals = SidangProposal::with(['dokumen_sidang', 'mahasiswa', 'nilaiKetua'])
            ->where('status', 1)
    ...
    public function nilaiDosen($id)
    {
        ...
        return view('pages.dosen.nilaiTampil.nilai', compact('nilaiPembimbing1', 'nilaiPembimbing2', 'nilaiPenguji', 'ratapembimbing', 'ratapenguji', 'totalnilai', 'statusSidang'));
    }
